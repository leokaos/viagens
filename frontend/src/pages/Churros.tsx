                            ...
                            <div className="space-y-2">
                                {days.map(day => (
                                    <button
                                        ...
                                        className={`w-full flex justify-between items-center px-4 py-3 rounded-xl text-xs font-bold transition-all ${
                                            selectedDay === day.id 
                                                ...
                                                <div className="flex-1 bg-white p-6 rounded-2xl shadow-sm border border-transparent hover:border-[#cbdbf5] transition-all relative">
                                                    ...
                                                    {activity.status && (
                                                        <Badge 
                                                            ...
                                                            className={`absolute top-6 right-20 text-[8px] font-black border-none px-2 py-0.5 rounded ${
                                                                activity.status === 'RESERVED' ? 'bg-[#d1e8ff] text-[#001d4a]' : 'bg-[#fee2e2] text-[#991b1b]'
                                                            }`} 
                                                        />
                                                    )}
                        ...
                        <div className="col-span-3 space-y-6">
                            ...
                            <Card className="p-0 overflow-hidden rounded-2xl shadow-sm border-none bg-white">
                                <div className="h-48 bg-[#f1f5f9] relative">
                                    {/* Mock Map Image */}
                                    <img src="https://api.mapbox.com/styles/v1/mapbox/light-v10/static/135.7681,35.0116,12/400x300?" alt="Map" className="w-full h-full object-cover grayscale opacity-50" />
